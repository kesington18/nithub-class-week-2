var numbers = [2, 6, 0, 9, 3, 1, 8, 7];
function insertionSort(array) {
    // create a for loop
    for (var i = 1; i < array.length; i++) { //i = 1 (first iteration), i = 2 (second iteration)
        var currentValue = array[i]; // 6,  0
        var j = i - 1; // 1-1 = 0, 2-1=1
        ...
        if (array[j + 1] !== currentValue)
            array[j + 1] = currentValue; // [0, 2, 6, 9, 3, 1,]
    }
    console.log(array);
}
